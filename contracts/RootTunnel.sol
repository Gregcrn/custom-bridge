 ...
 * @title RootTunnel
 */
contract RootTunnel is FxBaseRootTunnel, Create2 {
    ...
    function deposit(
        address rootToken, // root token
        address user, // user address on matic
        uint256 amount, // amount of tokens
        bytes memory data, // data to pass to receiver
        uint256 nonce, // nonce
        ...
        bytes memory message = abi.encode(
            DEPOSIT,
            abi.encode(rootToken, user, amount, data, nonce, deadline, v, r, s)
        );
